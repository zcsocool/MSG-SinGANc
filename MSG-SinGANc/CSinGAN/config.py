...
def get_arguments():
    ...
    parser.add_argument('--nfc', type=int, help='number of filters per conv layer', default=32)
    ...
    parser.add_argument('--max_size', type=int, help='image minimal size at the coarser scale', default=500)
    ...
    parser.add_argument('--niter', type=int, default=550, help='number of epochs to train per scale')
    parser.add_argument('--post_niter', type=int, default=220, help='number of epochs to training post_model per scale')
